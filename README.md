...
It is assumed that the user already has Anaconda or another python interpreter installed. If not, please download Anaconda from the link below:
...
For the convolutional neural network (CNN), it is recommended to use Amazon Web Services (AWS). The EC2 instance is p2.xlarge using <i>"Deep Learning AMI with Source Code -CUDA 8- Ubuntu"</i>.
